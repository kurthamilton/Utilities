...
;(function()
{
	...
	function Brush()
	{
		...
		var keywords =	'absolute action add after alter as asc at authorization begin bigint ' +
						'binary bit by cascade catch char character check checkpoint close collate ' +
						...
						'translation trigger try true truncate uncommitted union unique update values ' +
						'varchar varying view when where while with work';

		var operators =	'all and any between cross exists in join like not null or outer some';
